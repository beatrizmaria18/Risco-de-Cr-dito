...
with tab3:
    ...
    try:
        ...
        categorical_transformer = model.named_steps['preprocessor'].transformers_[1][1]
        ohe_features = categorical_transformer.named_steps['onehot'].get_feature_names_out(categorical_features)
